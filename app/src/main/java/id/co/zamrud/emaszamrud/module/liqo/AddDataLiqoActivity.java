...
public class AddDataLiqoActivity extends AppCompatActivity implements
        ButtonCallBack,
    ...
    private void startSave() throws JSONException {
        ...
        try {
            ...
            final Call<PostExecuteDatabase> call = databaseClient.insertDataLiqo(ajsonparam);
    ...
    public void runAlertDialog2(String imsg, int itipe, String iopsi) { //1 error, 2 sukses, 3 info
        ...
        alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                dialog.dismiss();
                if(iopsi == "update"){
                    Intent intent = new Intent(AddDataLiqoActivity.this, LiqoActivity.class);
                    intent.putExtra("tanggal", (Serializable) mTanggal);
                    startActivity(intent);
                    overridePendingTransition(R.anim.enter, R.anim.exit);
                }
