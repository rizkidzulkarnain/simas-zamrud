...
public class DataShalatParent {
    ...
    @Expose
    private DataShalatWeather todayWeather;
    @SerializedName("link")
    @Expose
    private String link;
    ...
    @Expose
    private List<DataShalatItem> items = null;
    ...
    public DataShalatWeather getTodayWeather() {
        return todayWeather;
    }

    public void setTodayWeather(DataShalatWeather todayWeather) {
    ...
    public List<DataShalatItem> getItems() {
        return items;
    }

    public void setItems(List<DataShalatItem> items) {
        this.items = items;
    }
