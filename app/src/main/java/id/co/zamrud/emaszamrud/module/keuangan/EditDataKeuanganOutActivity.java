...
public class EditDataKeuanganOutActivity extends AppCompatActivity implements ButtonCallBack {
    ...
    DataKeuanganItemClass mDataPengeluaranItem = new DataKeuanganItemClass();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDataPengeluaranItem = (DataKeuanganItemClass) getIntent().getSerializableExtra("pass_data_pengeluaran");
    ...
    public void setupForm(){
        formElementJenisPengeluaran = FormElementMemo.createInstance()
                ...
                .setValue(mDataPengeluaranItem.getJenis())
                .setRequired(true)
                .setTag(80);
        ...
        formElementJumlahPengeluaran = FormElement.createInstance()
                ...
                .setRequired(true)
                .setValue(mDataPengeluaranItem.getJumlah())
    ...
    public void callbackButtonReturn(FormElementButton formElementButton, Object o) {
        ...
        if (validatorResult.size() <= 0) {
            mDataPengeluaranItem.setJenis(formElementJenisPengeluaran.getValue());
            mDataPengeluaranItem.setJumlah(formElementJumlahPengeluaran.getValue());
            mDataPengeluaranItem.setTanggal(mTanggal);
    ...
    private void startUpdate() throws JSONException {
        ...
        try {
            String ajsonparam = mapper.writeValueAsString(mDataPengeluaranItem);
            IDatabaseClient databaseClient = ApiGenerator.createService(IDatabaseClient.class);
            final Call<PostExecuteDatabase> call = databaseClient.updateDataPengeluaran(ajsonparam);
    ...
    public void runAlertDialog(String imsg, int itipe, final boolean isUpdate) { //1 error, 2 sukses, 3 info
        ...
        alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                dialog.dismiss();
                if (isUpdate) {
                    Intent intent = new Intent(EditDataKeuanganOutActivity.this, KeuanganActivity.class);
